    ...
    Public MustInherit Class 游戏(Of 鼠标光标, 图像类型, 画刷类型, 用户控件类型)
        ...
        Sub New(窗体 As 动态支持(Of 鼠标光标, 图像类型, 画刷类型, 用户控件类型).I游戏窗口,
            ...
            图像资源加载器 As 图像资源加载器(Of 图像类型),
                标记管理器 As 动态支持(Of 鼠标光标, 图像类型, 画刷类型, 用户控件类型).I标记管理器)
            Me.窗体 = 窗体
            Me.标记管理器 = 标记管理器
            Me.声音资源加载器 = 声音资源加载器
            Me.图像资源加载器 = 图像资源加载器
        ...
        Public ReadOnly Property 标记管理器 As 动态支持(Of 鼠标光标, 图像类型, 画刷类型, 用户控件类型).I标记管理器 Implements 动态支持(Of 鼠标光标, 图像类型, 画刷类型, 用户控件类型).I游戏.标记管理器
